  ...
  <div class="container-fluid">
    <div class="page-content-wrap">
       ...
       <div class="breadcrumb">
        <button onclick="listarInstalaciones();">Equipos</button>
        <button onclick="listarInstalacionesMate();">Materiales</button>
        
<!--         <button onclick="Hola1();">Materiales</button>
        <button onclick="Hola2();">Equipos</button> -->
      </div>

       <div id="listainstalaciones">
       </div>
       <div id="listainstalacionesmat" style="display: none">
       </div> 
...
function listarInstalaciones()
{
  ...
  var tabla ="<table id='tablainstalacion' class='table table-bordered table-responsive'><thead><tr><th>Nro</th><th>Cliente</th><th>Equipo</th><th>Serie</th><th>Fecha</th><th>OT</th><th>Acciones</th></tr></thead><tbody>";
    var nro =1 ;
...
function listarInstalacionesMate()
{
  ...
  var url = "<?php echo "$raiz";?>Inicio/ListaInstalacion";
  var tabla ="<table id='tablainstalacion2' class='table table-bordered table-responsive'><thead><tr><th>Nro</th><th>Cliente</th><th>Materiales</th><th>Cantidad</th><th>Fecha</th><th>OT</th><th>Acciones</th></tr></thead><tbody>";
    var nro =1 ;
  $.get(url,null,function(res)
  {
   var lista = JSON.parse(res);
