...
<script type="text/javascript">
		...
		{  
			...
			else
			{
				...
				else
				{
					...
					var url="<?php echo $raiz; ?>Acciones/RegistrarTratamiento";
					...
					$.ajax({
						...
						success:function(res)
						{
							if (res == "OK") {
								...
								$("#AgregarTratamientos").modal('hide'); 
							}
							else
							{
	...
	{
		var url = "<?php echo $raiz;?>Acciones/ListaTratamiento";
		$.get(url,null,function(res){
			...
			tabla+="<div class='col-md-12'><div class='widget widget-danger widget-no-subtitle'><div class='widget-big-int'><span class='num-count'>"+st+"</span></div>                            <div class='widget-subtitle'>Tratamientos Registrados</div><div class='widget-controls'><a href='#' class='widget-control-left'><span class='fa fa-cloud'></span></a></div></div></div></tbody></table>";
			$("#lsinto").html(tabla);
